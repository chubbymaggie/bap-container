...
(* OASIS_START *)
(* DO NOT EDIT (digest: 72ebba4abc07923463ab38c5d163c11e) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_leb128", []))];
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Exec_container"; "Elf_container"];
                      lib_pack = false;
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "bap-container";
                      lib_findlib_name = Some "leb128";
                      lib_findlib_containers = []
                   });
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "test_leb128.ml"});
               Test
                 ({
                     cs_name = "leb128";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "k\163\166\128-L\146\148\021rH\146\014\022\137#";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
